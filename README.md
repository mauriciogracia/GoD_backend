...
1. Go to the `GoD_backend` folder and run the command `docker build . -t god_backend`
2. Then you need to run the docker container `docker run -d -p 5000:5000 god_backend`
